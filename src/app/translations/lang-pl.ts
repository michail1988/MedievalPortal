...
export const LANG_PL_TRANS = {
    ...
    'letter-9': 'Uczestnikom imprezy zapewniony zostanie hotel, wyżywienie oraz komplet materiałów kongresowych, przy czym opłata konferencyjna wyniesie około 320 zł; przewidziane są zniżki dla doktorantów. Ostatecznie kwoty opłat uda się ustalić po otrzymaniu decyzji o wysokości dofinansowania ministerialnego (w maju br.). W wypadku uczestników mieszkających we Wrocławiu i niekorzystających z bazy hotelowej opłata wyniesie 100 zł + VAT (co pozwoli zapewnić posiłki w trakcie obrad i komplet materiałów kongresowych).',
    'letter-10': 'Zapytania i propozycje w sprawach organizacyjnych proszę kierować na adres mailowy: <a href="mailto:stanislaw.rosik@uwr.edu.pl"><u>stanislaw.rosik@uwr.edu.pl</u></a>',
    ...
    'letter-date': 'Wrocław, 19.04.2018',
